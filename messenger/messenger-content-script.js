...
function selectEmoji(emoji) {
    ...
    // insert the new emoji to Facebook input
    let elm = document.getElementsByClassName("xzsf02u x1a2a7pz x1n2onr6 x14wi4xw x1iyjqo2 x1gh3ibb xisnujt xeuugli x1odjw0f")[0];
    elm.dispatchEvent(new InputEvent("input", { data: emoji.native, isComposing: true }));
}
...
var mutationObserver = new MutationObserver((mutations) => {
    ...
    let emojiContainer = document.getElementsByClassName("x9f619 x1jx94hy x8ii3r7 x1qpq9i9 xdney7k xt3gfkd x6ikm8r x10wlt62 x5pf9jr")
    if (emojiContainer.length == 0) return;

    // replace the old emoji picker with the new emoji picker
    let newEmojiPicker = new EmojiMart.Picker(pickerOptions);
    emojiContainer[0].replaceWith(newEmojiPicker);
});
